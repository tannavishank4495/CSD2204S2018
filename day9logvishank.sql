...
MariaDB [csd2204s18]> select * from loactions;
...
MariaDB [csd2204s18]> select first_name,last_name from employees where employees where employee_id IN (select distinct(manager_id) from employees where manager_id !=0);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'where employee_id IN (select distinct(manager_id) from employees where manager_i' at line 1
...
MariaDB [csd2204s18]> select firstjob_id from employees;
ERROR 1054 (42S22): Unknown column 'firstjob_id' in 'field list'
...
MariaDB [csd2204s18]> select department_id from departments where departments where department_name LIKE 'IT%';
